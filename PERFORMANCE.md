...
| ------------------------ | --------- | -------- | -------- | -------------- |
| **本库 (AC自动机)**      | **53ms**  | 68MB     | 8        | ✅**完整匹配** |
| ayoyu/flashtext (Trie树) | 35ms      | 52MB     | 32       | ❌ 遗漏重叠    |
| 正则表达式 (regexp)      | 26,300ms  | 7MB      | 26,297   | ✅ 完整匹配    |

**核心指标**:

- ⚡ 比正则表达式快 **500倍**
- 🎯 比ayoyu/flashtext慢 **1.5倍**，但**匹配更完整**
- 📦 内存使用合理（68MB用于10000关键词）
...
**关键**: 性能与关键词数量无关，性能稳定，正则表达式则是**指数增长**。
